...
- **A PDF has no underline and no strike, and both were lost:** where a
  ...
  than running to the margins. That last is what keeps a paragraph's
  border, a table's line and a bar of colour behind a highlighted word out
  of it — a border runs margin to margin, a table's rule the width of its
