...
M1 and M2's device-independent work are complete. M2 remainder: print-pipeline and PDF-renderer polish after device testing. M3: OCR (ML Kit + Tesseract). M4: Google Docs sync + Review Mode.
