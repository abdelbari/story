...
M1 remainder: untagged PDF table detection, share-sheet targets, image extraction + media parts. M2: DOCX→PDF print pipeline + full BiDi run analysis (UAX #9). M3: OCR (ML Kit + Tesseract). M4: Google Docs sync + Review Mode.
