...
- **Every table of a converted document had a blank line under it:**
  ...
  list and style named actually defined — over a document holding every
  part a document can have, over that document written, read and written
  again, and over every document of the corpus. The checker is made to
  fail on purpose by three packages broken the three ways, because a
