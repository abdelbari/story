...
M1 is complete. M2 remainder: print-pipeline polish after device testing, direct-to-file PDF export, full BiDi run analysis (UAX #9). M3: OCR (ML Kit + Tesseract). M4: Google Docs sync + Review Mode.
